...
WORKDIR = os.getcwd()
log_file = f"{WORKDIR}/06_dataset_preparation/create_training_static_features_hdf5_file.txt"  # Path to the log file
...
landcover_2020_data = rasterio.open("data/aux_data/land_cover/2020/reprojected_resampled/2020_landcover_finalized.tif")
landcover_2021_data = rasterio.open("data/aux_data/land_cover/2021/reprojected_resampled/2021_landcover_finalized.tif")
copdem_data = rasterio.open("data/aux_data/copdem/reprojected_resampled/copdem_90m_finalized.tif")
biomes_data = rasterio.open("data/aux_data/biomes/reprojected_resampled/biomes_2017_finalized.tif")
fldk_data = "data/himawari8/2020/01/01/0500/0430/2020_01_01_0500_0430_stacked_masked.tif" #sample file for reference
...
with h5py.File('data/train_test_split_data_files/train_split/static_files/training_static_data.h5', 'w') as f:
